...
//    private Queue<String> urlQueue = new ConcurrentLinkedQueue<String>();
    ...
    public  StartMovieCount(){}

    public  StartMovieCount(String url){
...
//        movie.setSolrService(new SolrServiceImpl());
...
//        //豆瓣top250页面
       // String url = "https://movie.douban.com/top250?start=0&filter=";
        String url = "https://movie.douban.com/subject/6534248/";
